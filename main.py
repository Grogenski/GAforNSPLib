...
for gen in range(0, 8):
    ...
    quantidade_selecionada = int(mp['inst_rate'] * 7290)
    ...
    for nsp in amostra:
        ...
        pop_size = mp['pop_size']
        num_generations = mp['num_generations']
        mutation_rate = mp['mutation_rate']
